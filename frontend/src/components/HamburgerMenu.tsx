...
const HamburgerMenu = () => {
    return (
      ...
      <Menu right>
        ...
        <Link to="/movies" className="menu-item">Series</Link>
        <Link to="/movies" className="menu-item">Drama</Link>
        <Link to="/movies" className="menu-item">Action</Link>
        <Link to="/movies" className="menu-item">Fantasy</Link>
        <Link to="/movies" className="menu-item">Comedy</Link>
        
        <Link to="/movies" className="menu-item">Family</Link>
        <Link to="/movies" className="menu-item">Romance</Link>
        <Link to="/movies" className="menu-item">Science Fiction</Link>
