  ...
  return (
    <footer className="footer">
      <div className="footer__container">
        <div className="footer__about">
          ...
          <p className="footer__description">
            Movie Mingle is your go-to platform for streaming a wide variety of
            movies and series from all genres.
          </p>
        </div>
      ...
      <div className="footer__bottom">
        <p>
          &copy; {new Date().getFullYear()} Movie Mingle. All rights reserved.
        </p>
      </div>
    </footer>
  );
