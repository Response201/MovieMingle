...
const CheckoutForm: React.FC<CheckoutFormProps> = ({ price, setShowPayment }) => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const { data } = await axios.post('http://localhost:3000/create-payment-intent', { amount: price * 100 });
