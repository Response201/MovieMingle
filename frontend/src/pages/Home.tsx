    ...
    <>
      <div className="home-wrapper">
        ...
        <div className="scroll-icon" onClick={scrollToMovies}>
          <svg className="arrow-down" width="40px" height="40px" viewBox="0 -4.5 20 20" version="1.1"  fill="#ffffff" stroke="#ffffff">
